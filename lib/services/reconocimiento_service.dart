...
import 'traduccion_service.dart';
...
class ReconocimientoService {
  ...
  final TraduccionService _traductor = TraduccionService();
  ...
  final descripcionEnIngles = 'Detecto: $principales.';

  return _traductor.traducir(descripcionEnIngles);
}
